(function(window) {
  ...
  var tracker = {
    ...
    initialize: function(config) {
      ...
      this.maxCookieSize = config.maxCookieSize || this.maxCookieSize;
    ...
    track: function(payload) {
      ...
      // Set tracker meta data
      payload.meta_data = payload.meta_data || {};
      payload.meta_data.web_pixel_version = this.version;
      payload.meta_data.server_domain = this.serverDomain;
      payload.meta_data.use_cookies = this.useCookies;
      payload.meta_data.cookie_domain = this.cookieDomain;
      payload.meta_data.session_duration = this.sessionDuration;
    ...
    setCookie: function(name, value, expireDate) {
      ...
      if (value && value.length > this.maxCookieSize) {
        this.log('Cookie size exceeded');
        return;
      }
